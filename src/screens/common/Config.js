...
const routes = {
    ...
    // BASE_URL: "http://192.168.29.140:8090",  //Kalyani OLD lappi
    // BASE_URL: "http://192.168.29.171:8090",  //Kalyani IP whizzard
    ...
    // BASE_URL: "http://192.168.0.106:8090",  //SAI OFFICE IP Tech#2
    ...
    BASE_URL: "http://api.whizzard.in",  // live URL

    APP_VERSION_NUMBER:'2.5.59', //2.5.59 //59 is live deployed //2.5.45 is test //2.5.37 is jeevan
    ...
    GET_SHIFTS_FROM_SITE_ID: "/api/v1/userShift/getSiteShiftSummary/",
