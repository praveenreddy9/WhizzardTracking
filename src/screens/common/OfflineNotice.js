...
//       <View
//         style={[Styles.flex1, {justifyContent: 'center', alignSelf: 'center'}]}>
//         {/*<MaterialIcons*/}
...
//       } else {
//         Alert.alert(
//           'App needs Background Location Permissions',
//           'Select Allow all the time in App Permissions',
//           [
//             {
//               text: 'Ask Again',
//               onPress: () => {
...
//           Alert.alert(
//             '',
//             'Your Location data is missing, Please clear cache in GOOGLE MAPS',
//             [
//               {
//                 text: 'OK',
//                 onPress: () => {
...
//           if (currentShiftStatus.status === 'SHIFT_IN_PROGRESS') {
//             // this.requestLocationPermission();
//             this.checkDeviceInfo();
//             this.checkLocationisRunning();
//           } else if (
//             currentShiftStatus.status === 'INIT' ||
//             currentShiftStatus.status === 'MARKED_ATTENDANCE'
//           ) {
//             this.checkDeviceInfo();
//             this.stopLocation();
//           } else {
...
//     await LocationService.isLocationRunning(
//       err => {
...
//     await LocationService.stopLocation(
//       err => {
